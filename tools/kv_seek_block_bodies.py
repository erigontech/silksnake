#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""The kv_seek_block_bodies command allows to query the turbo-geth/silkworm KV 'Block Bodies'."""
...
encoded_block_number = sedes.encode_block_number(int(args.block_number))

print('REQ block_number:', args.block_number)

key, value = kv_utils.kv_seek(kv_metadata.BLOCK_BODIES_LABEL, encoded_block_number, args.target)

block_number, block_hash = sedes.decode_block_key(key)
assert block_number == int(args.block_number), 'ERR block number does not match!'
